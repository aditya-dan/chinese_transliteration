...
hanzi_corpus, pinyin_corpus = tokenize("../texts/cat.txt")
train_sgns_model(hanzi_corpus, 100, 3, 1, 100, "../models/hanzi_spacy.model")
train_sgns_model(pinyin_corpus, 100, 3, 1, 100, "../models/pinyin_spacy.model")